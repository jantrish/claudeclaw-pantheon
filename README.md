...
**Начинаем с одного - растём до команды.** Этот репозиторий разворачивает одного агента-программиста. Когда освоишься - добавишь других агентов. Инфраструктура готова.
...
```bash
git clone https://github.com/jantrish/claudeclaw-panteon.git
cd claudeclaw-panteon
npm install
```
